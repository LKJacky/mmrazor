...
class BaseBasicBlock(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(BaseBasicBlock, self).__init__(init_cfg=init_cfg)
...
class BaseBottleneck(BaseModule):
    ...
    def __init__(self,
                 ...
                 drop_path_rate=0.0,
                 init_cfg=None):
        super(BaseBottleneck, self).__init__(init_cfg=init_cfg)
...
class ResNetDMS(BaseBackbone):
    ...
    def __init__(self,
                 ...
                 drop_path_rate=0.0):
        super(ResNetDMS, self).__init__(init_cfg)
